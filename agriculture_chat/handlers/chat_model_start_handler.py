...
boxen_print("Hello, World!", title="Greetings", color="green", padding=1)

class ChatModelStartHandler(BaseCallbackHandler):
    def on_chat_model_start(self, serialized, messages, *args, **kwargs):
        print("\n\n======= Sending Messages ==========\n\n")
        ...
        for message in messages[0]:
            if message.type == "system":
                ...
                func_line = f"{tool}({tool_input})"
                boxen_print(func_line, title=message.type, color="cyan")    
